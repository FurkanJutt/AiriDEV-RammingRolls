...
public class UIGradient : BaseMeshEffect
{
	...
	void OnEnable(){
		m_color1 = new Color (Random.Range(0.1f,1.0f),Random.Range(0.1f,1.0f),Random.Range(0.1f,1.0f));
		m_color2 = new Color (Random.Range(0.1f,1.0f),Random.Range(0.1f,1.0f),Random.Range(0.1f,1.0f));
	}
    [Range(-180f, 180f)]
